...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-trans ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" id="man_btn">
                <!--  data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation" -->
            ...
            <div class=" navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto" id="manuu_dow">
                    ...
                    <li class="nav-item"><a href="javascript:void(0);" class="nav-link link">Community</a>
                        <ul class="submenu">
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Community"
                                    class="nav-link">Collabs</a></li>
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Community"
                                    class="nav-link">Contest</a></li>
                        </ul>
                    </li>
            ...
            ?>
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Sounds/<?=$category['id'];?>"
            ...
            -->
                    ...
                    <li class="nav-item"><a href="javascript:void(0);#" class="nav-link link">Blogs</a>
                        <ul class="submenu ">
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Blogs/1" class="nav-link">Tip's
                                    and How to's</a></li>
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Blogs/2" class="nav-link">Giving
                                    Game</a></li>
                        </ul>
                    </li>
                    <!--
        ...
        ?>
                    <li class="nav-item">
                        <a href="javascript:void(0);" class="nav-link link">
                            Welcome <?=$userdata['first_name'];?>, <img class="profile_img"
                                src="<?=$BASE_URL .$profile;?>" width="20px" height="20px">
                        </a>
                        <ul class="submenu">
                            <?php
                  if($userdata['is_email_verified']){
                ?>
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Profile"
                                    class="nav-link">Dashboard</a></li>
                            <li class="nav-item submenu_item" style="display:none;"><a href="#"
                                    class="nav-link">Favorites</a></li>
                            <li class="nav-item submenu_item" style="display:none;"><a href="#" class="nav-link">Edit
                                    profile</a></li>
                            <li class="nav-item submenu_item" style="display:none;"><a href="#"
                                    class="nav-link">Billings</a></li>
                            <?php
                  }
                ?>
                            <li class="nav-item submenu_item"><a href="<?=$BASE_URL;?>Logout" class="nav-link">Log
                                    Out</a></li>
                        </ul>
                    </li>
                    <?php
        ...
        ?>
                    <li class="nav-item cta"><a href="#" class="nav-link" data-toggle="modal"
                            data-target="#loginModal"><span>Log In</span></a></li>
                    <li class="nav-item cta"><a href="#" class="nav-link" data-toggle="modal"
