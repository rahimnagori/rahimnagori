...
<head>
    ...
    <link rel="stylesheet"
        href="<?=site_url('assets/');?>admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <link rel="stylesheet"
        href="<?=site_url('assets/');?>admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
    <link rel="stylesheet"
        href="<?=site_url('assets/');?>admin/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
    <link rel="stylesheet"
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?=site_url();?>Admin"><img src="<?=site_url('assets/site/');?>img/logo.png" height=""
                    width="350px" alt="Rahim Nagori"></a>
        </div>
        <!-- /.login-logo -->
        <div id="error"></div>
